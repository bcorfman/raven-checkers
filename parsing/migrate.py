...
class RCF2PDN:
    ...
    def _read_input(self, rcf_stream):
        rcf_tags = {"<description>": self._read_description, "<setup>": self._read_setup, "<moves>": self._read_moves}
    ...
    def _transform_input(self):
        ...
        self._game = Game(
            ...
            list(self.black_men),
            list(self.white_men),
            list(self.black_kings),
            list(self.white_kings),
            result,
            orientation,
            description,
            self.moves,
    ...
    def _validate_input(self):
        return (
            self.num_players in range(3)
            and self.next_to_move in ["black", "white"]
            and self.flip_board in range(2)
            and self.moves
            and (self.black_men or self.black_kings or self.white_men or self.white_kings)
        )
