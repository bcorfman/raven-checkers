...
class ShortDykeEvaluator(GoalEvaluator):
    ...
    def calculate_desirability(self, board):
        ...
        return measure_formation_closeness(short_dyke, board)
...
class LongDykeEvaluator(GoalEvaluator):
    ...
    def calculate_desirability(self, board):
        ...
        return measure_formation_closeness(long_dyke, board)
...
class PyramidEvaluator(GoalEvaluator):
    ...
    def calculate_desirability(self, board):
        ...
        return measure_formation_closeness(pyramid, board)
...
class PhalanxEvaluator(GoalEvaluator):
    ...
    def calculate_desirability(self, board):
        ...
        return measure_formation_closeness(phalanx, board)
...
class MillEvaluator(GoalEvaluator):
    ...
    def calculate_desirability(self, board):
        ...
        return measure_formation_closeness(mill, board)
...
class EchelonEvaluator(GoalEvaluator):
    ...
    def calculate_desirability(self, board):
        ...
        return measure_formation_closeness(echelon, board)
