...
Raven is a checkers game program, for one or two players. (Windows, Ubuntu 22, and MacOS ARM [downloads available](https://github.com/bcorfman/raven-checkers/releases).) While there are examples of excellent & free checkers programs out on the net (such as [Martin Fierz's Checkerboard](http://www.fierz.ch/checkers.htm)), Raven features are designed primarily for learning checkers, basic AI algorithms, and application design in Python.
...
* **Cross-platform**. Raven has been tested on Python 3.12-3.14 with Windows, OS X, and Linux, and that means the code itself is not locked into a particular operating system. The GUI is written with Python's built-in cross-platform GUI, Tkinter.
