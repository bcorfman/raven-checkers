...
def test_board_to_PDN_ready():
    ...
    board_moves = [
        Move([[square_map[9], BLACK | MAN, FREE], [square_map[13], FREE, BLACK | MAN]], ""),
        ...
        Move(
            [
                [square_map[14], BLACK | MAN, FREE],
                [square_map[18], WHITE | MAN, FREE],
        ...
        Move(
            [
                [square_map[27], WHITE | MAN, FREE],
                [square_map[23], BLACK | MAN, FREE],
                [square_map[18], FREE, FREE],
                [square_map[15], BLACK | MAN, FREE],
        ...
        Move(
            [
                [square_map[8], BLACK | MAN, FREE],
                [square_map[11], WHITE | MAN, FREE],
        ...
        Move(
            [
                [square_map[10], BLACK | MAN, FREE],
                [square_map[14], WHITE | MAN, FREE],
        ...
        Move(
            [
                [square_map[21], WHITE | MAN, FREE],
                [square_map[17], BLACK | MAN, FREE],
        ...
        Move(
            [[square_map[24], WHITE | MAN, FREE], [square_map[20], FREE, WHITE | MAN]],
        ...
        Move([[square_map[25], WHITE | MAN, FREE], [square_map[21], FREE, WHITE | MAN]], "32-27; 4-8 25-21 same"),
...
def test_parse_PDN_string_success():
    ...
    board_moves = [
        ...
        for m in [
            ...
            [[35, 9, 16], [30, 16, 9]],
            [[13, 6, 16], [7, 16, 10]],
            [[47, 9, 16], [41, 10, 16], [35, 16, 9]],
            [[29, 10, 16], [35, 9, 16], [41, 16, 10]],
            [[41, 9, 16], [35, 16, 9]],
            [[18, 6, 16], [13, 16, 6]],
            [[46, 9, 16], [41, 16, 9]],
            [[23, 6, 16], [18, 16, 6]],
            ...
            [[41, 6, 16], [36, 16, 6]],
            [[15, 5, 16], [20, 16, 5]],
            [[24, 6, 16], [18, 5, 16], [12, 16, 6]],
            [[13, 5, 16], [19, 16, 5]],
            [[29, 6, 16], [24, 16, 6]],
            [[20, 5, 16], [25, 6, 16], [30, 16, 5]],
            [[46, 6, 16], [41, 16, 6]],
            [[14, 5, 16], [20, 16, 5]],
            [[48, 6, 16], [42, 16, 6]],
            [[12, 5, 16], [17, 16, 5]],
            [[45, 6, 16], [40, 16, 6]],
            [[8, 5, 16], [13, 16, 5]],
            [[37, 6, 16], [31, 5, 16], [25, 16, 6]],
            [[19, 5, 16], [25, 6, 16], [31, 16, 5]],
            [[31, 6, 16], [25, 16, 6]],
            [[13, 5, 16], [18, 16, 5]],
            ...
            [[41, 6, 16], [36, 5, 16], [31, 16, 6]],
            [[26, 5, 16], [31, 6, 16], [36, 16, 5]],
            [[28, 6, 16], [23, 16, 6]],
            [[20, 5, 16], [26, 16, 5]],
            [[40, 6, 16], [35, 16, 6]],
            [[6, 5, 16], [12, 16, 5]],
            [[34, 6, 16], [28, 16, 6]],
            [[12, 5, 16], [18, 6, 16], [24, 16, 5]],
            [[30, 6, 16], [24, 5, 16], [18, 16, 6]],
            [[18, 5, 16], [24, 16, 5]],
            [[42, 6, 16], [36, 5, 16], [30, 16, 6]],
            [[24, 5, 16], [30, 6, 16], [36, 16, 5]],
            [[36, 6, 16], [31, 16, 6]],
            [[13, 5, 16], [19, 16, 5]],
            [[35, 6, 16], [30, 16, 6]],
            [[19, 5, 16], [24, 16, 5]],
...
def test_translate_to_fen():
    ...
    black_kings = [30]
    white_kings = [27]
    assert translate_to_fen(next_to_move, black_men, white_men, black_kings, white_kings) == "W:W26,K27:B17,K30"
