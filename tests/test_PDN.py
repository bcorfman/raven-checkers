...
def test_parse_PDN_string_success():
    ...
    assert reader.PDNs[0].move_text == '1. 10-15 23-18 2. 7-10 22-17 3. 15-22 ' + \
...
def test_write_PDN_file_success(tmp_path):
    ...
    site = "Reutlingen"
    result = "1/2-1/2"
    move_text = "1. 11-15 22-17 2. 15-19 24x15 3. 10x19 23x16 4. 12x19 25-22 " + \
...
def test_write_PDN_string_success():
    ...
    white = "Pawlek, Dennis"
    result = "1/2-1/2"
    move_text = "1. 11-15 22-17 2. 15-19 24x15 3. 10x19 23x16 4. 12x19 25-22 5. " + \
