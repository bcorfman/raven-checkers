...
def test_parse_PDN_string_success():
    ...
    reader.read_game(0)
    assert reader._games[0].event == "Casual Game"
    assert reader._games[0].date == "2019.11.26"
    assert reader._games[0].white_player == "Jubai"
    assert reader._games[0].black_player == "windycity"
    assert reader._games[0].result == "1-0"
    assert reader._games[0].moves == [[[10, 15], [23, 18]], [[7, 10], [22, 17]],
...
def test_write_PDN_string_success():
    ...
    assert pdn == '[Event "German Open 2004"]\n' + \
           ...
           '1. 11-15 22-17 2. 15-19 24x15 3. 10x19 23x16 4. 12x19 25-22 5. 7-10 27-24\n' + \
           '6. 10-15 17-13 7. 9-14 29-25 8. 6-10 22-17 9. 1-6 26-23 10. 19x26 30x23\n' + \
           '11. 8-11 24-19 12. 15x24 28x19 13. 3-7 25-22 14. 11-15 32-28 15. 15x24 28x19\n' + \
           '16. 7-11 19-16 17. 11x20 23-19 18. 14-18 22x15 19. 4-8 31-27 20. 5-9 27-23\n' + \
           '21. 9-14 19-16 22. 10x19x26 17x10x1 1/2-1/2\n'
